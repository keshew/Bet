...
class NotificationManager: NSObject, ObservableObject, UNUserNotificationCenterDelegate {
    ...
    func scheduleNotificationEvent(event: EventModel) {
        ...
        guard let remindBeforeMinutes = Int(event.remindBefore) else {
            print("Invalid remindBefore value")
            return
        }
    ...
    func scheduleNotificationTask(task: TaskModel) {
        ...
        guard let remindBeforeMinutes = Int(task.reminder) else {
            print("Invalid remindBefore value")
            return
        }
